...
SmartRead 是一个本地优先的 AI 阅读器，适合在手机上导入 EPUB、PDF、TXT 后阅读、听书、做 AI 逐页解读和管理个人书库。它支持自定义 OpenAI-compatible API，可以使用自己的 API Base URL、API Key 和模型名接入兼容服务。它的重点不是账号系统或云同步，而是把正文阅读、AI 解读、听书字幕、漫画和复杂图文混排内容做成可离线、自用、可控的单机体验。
...
- AI 逐页解读：对当前页、章节或选中文本生成解读，适合长文、专业书和图文混排内容。
